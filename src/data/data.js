...
export const ENERGY_CONFIG = {
  cerah: {
    ...
    greeting: 'Hari yang produktif, Rania.',
    contextMessage: 'Mulai dari yang berat. Kamu sedang siap.',
    hint: '{n} tugas lain di bawah.',
    cardSize: 'normal',
  ...
  berawan: {
    ...
    allowPriorities: ['high', 'med', 'low'],
    greeting: 'Halo, Rania.',
    contextMessage: 'Lima tugas penting hari ini. Itu cukup.',
    hint: '{n} tugas lain disembunyikan dari daftar.',
    cardSize: 'normal',
    showPriorityDot: true,
  },
  redup: {
    ...
    maxTasks: 3,
    allowPriorities: ['low'],
    greeting: 'Pelan saja hari ini, Rania.',
    contextMessage: 'Tiga tugas ringan. Sisanya nanti.',
    hint: 'Sisanya nanti.',
    cardSize: 'large',
